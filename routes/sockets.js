...
exports.initialize = function  (server) {
    ...
    this.chatInfra.on("connection", function (socket) {//在该通道上建立连接
        ...
        //         //向客户端发送事件传递数据 客户端要有on接受响应的name_set方法
        //         socket.emit("name_set", data);
        //         //向客户端发送数据 客户端有on（“message”）接受
        ...
        //         var comSocket = self.chatCom.sockets[socket.id];//获得chatCom
        //         comSocket.join(room.name);//将chatCom加入房间
        ...
        //             // rooms[roomName] = io.sockets.message.rooms[room].lenght;
